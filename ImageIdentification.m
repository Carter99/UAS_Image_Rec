function [mode_maxIndex,HueIndex]=ImageIdentification(inputImg,W_i_h1,W_h1_h2,W_h2_o,B_h1,B_h2,B_o)
    mode_maxIndex=-rand();
    HueIndex=-rand();
    ...
    %reshape(Local_imageVector,[25,25])
